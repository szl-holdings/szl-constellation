...
[HF Space (runtime)](https://huggingface.co/spaces/SZLHOLDINGS/szl-constellation) · [Build receipt (creddited → szl-lake)](https://huggingface.co/datasets/SZLHOLDINGS/szl-lake/blob/main/receipts/2026-09-23/holo-shader-fabric-v1.json) · [Org](https://github.com/szl-holdings)
